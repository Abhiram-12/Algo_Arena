...
const Navbar = () => {
  ...
  const { isAuthenticated, isAdmin, username, logout } =
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/getUserstats`, {
        ...
        <div className=" nav ">
          ...
          <div className="nav__menu">
            <ul className="nav__list ">
              ...
              <li className="nav__item">
                <NavLink className="nav__link" to="/topics">
                  Topics
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink className="nav__link" to="/problems">
                  Problem List
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink className="nav__link" to="/contests">
                  Contests
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink className="nav__link" to="/playground">
                  Play Ground
                </NavLink>
              </li>
              {isAuthenticated ? (
                <li className="nav__item">
                  <i
                    className="bx bxs-user-circle user__icon "
